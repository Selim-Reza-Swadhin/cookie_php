                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal" action="<?= htmlentities($_SERVER['PHP_SELF']);?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="email2" name="email" placeholder="Username" value="<?php setValue("emailcookie"); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="password2" class="col-sm-2 control-label">Password</label>
                                <div class="col-sm-10">
                                    <input type="password" class="form-control" id="password2" name="password" placeholder="Password" value="<?php setValue("passwordcookie"); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <div class="checkbox">
                                        <label>
                                           <input type="checkbox" name="rememberme" <?php setChecked("emailcookie");?>> Remember me
                                        </label>
                                    </div>
                                </div>
                            </div>
